...
public class Main  {
    public static void main(String[] args) {
        ...
        basicKit.add(new WritingStationery("Pen", 1, 15, WritingColor.BLACK));
        ...
        System.out.println(basicKit.toString());
        Collections.sort(basicKit, new CostComparator());
        System.out.println(basicKit.toString());
        Collections.sort(basicKit, new NameComparator());
        System.out.println(basicKit.toString());
        Collections.sort(basicKit, new FullComparator());
        System.out.println(basicKit.toString());
    }
